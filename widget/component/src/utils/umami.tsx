...
export const UmamiScript = ({ miljo, children }: { miljo: Miljø, children: ReactNode }) => {
  const trackingId =
    miljo == 'prod' ?
      '3ab987de-cf5c-47a9-a04d-bcf6316f2204' : //PROD
      '16cf7325-ffda-4759-9657-4215b91eb3fd'; //DEV
