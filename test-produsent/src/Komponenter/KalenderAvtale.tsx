...
import { Button, Checkbox, Heading, Select, TextField, ToggleGroup } from '@navikt/ds-react';
    ...
    return (
        <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <Checkbox onChange={() => setKunDigitalt(!kunDigitalt)} checked={kunDigitalt}>
                    {' '}
                    Kun digitalt{' '}
                </Checkbox>
            </div>
            {kunDigitalt ? null : (
                <>
                    ...
                    <Checkbox onChange={() => setErDigitalt(!erDigitalt)} checked={erDigitalt}>
                        {' '}
                        Digitalt{' '}
                    </Checkbox>
                </>
            ...
            >
                <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                    ...
                    <Select defaultValue={''} ref={nyTilstand} label="Ny tilstand">
                        <option>""</option>
                        {Object.keys(KalenderavtaleTilstand).map((tilstand) => (
