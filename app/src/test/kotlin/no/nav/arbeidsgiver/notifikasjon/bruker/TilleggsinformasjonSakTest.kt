...
class TilleggsinformasjonSakTest {

    @Test
    fun `Sak med tilleggsinformasjon null`() = withTestDatabase(Bruker.databaseConfig) { database ->
        ...
        ktorBrukerTestServer(
            ...
            // Tilleggsinformasjon skal være null
            with(client.sakById(sak.sakId)) {
                assertNull(getTypedContent<String?>("$.sakById.sak.tilleggsinformasjon"))
            }

            // burde få ny tilleggsinformasjon med idempotensnøkkel null
            ...
            with(client.sakById(sak.sakId)) {
                assertEquals(
                    "tilleggsinformasjon",
                    getTypedContent<String?>("$.sakById.sak.tilleggsinformasjon")
                )
            }

            // burde få ny tilleggsinformasjon med idempotensnøkkel
            brukerRepository.tilleggsinformasjonHendelse(
